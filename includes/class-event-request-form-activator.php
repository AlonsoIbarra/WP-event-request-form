...
class Event_Request_Form_Activator {
	...
	public static function activate() {
		...
		abierto_al_publico TINYINT DEFAULT 1,
		...
		fecha_de_cierre varchar(15) DEFAULT '',
		...
		link_de_google_maps_de_recepcion varchar(200) DEFAULT '' NOT NULL,
		direccion_de_hotel varchar(200) DEFAULT '' NOT NULL,
		...
		fecha_de_cierre_bool TINYINT DEFAULT 0,
